        ...
        <ol>
          <li>
            ...
            <ul>
              ...
              <li>생성형 AI(Google Gemini)를 활용한 북마크 자동 제목·태그·요약</li>
            </ul>
          </li>
      ...
      <Article title="제5조의2 (AI 기반 부가 기능)">
        <ol>
          <li>
            ...
            해당 페이지의 제목·본문 일부를 분석하고 책장 표시용 자동 제목, 검색용 자동
            태그(2~4개) 및 한 줄 요약을 생성하여 함께 저장합니다.
          </li>
          <li>
            본 기능은 기본적으로 활성화되며, 이용자는 서비스 설정 메뉴의 "AI 자동 제목" 항목에서
            언제든지 비활성화할 수 있습니다. 비활성화 시 신규 북마크에 대한 AI 처리는 중지되며,
            기존에 생성된 제목·태그·요약은 그대로 유지됩니다.
          </li>
          <li>
